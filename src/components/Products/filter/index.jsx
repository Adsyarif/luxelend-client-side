...
const Filter = ({ setFilters, category }) => {
    ...
    useEffect(() => {
      ...
      fetch('http://127.0.0.1:5000/property_category')
    ...
    const renderOptionsForCategory = (categoryName) => {
      ...
      return (
        <>
          <option className='text-base' value="">{categoryName.charAt(0).toUpperCase() + categoryName.slice(1)}</option>
          {options.map((option) => (
          ...
          <div className="border-none">
            ...
            <div className="mb-4">
              <select
                ...
                style={customStyles.select}
              >
                {renderOptionsForCategory('style')}
              </select>
            </div>
