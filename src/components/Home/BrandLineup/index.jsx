...
export function BrandLineup() {
  return (
    <Card className="pb-4">
      ...
      <div className="flex flex-row mx-8 gap-6 text-xs font-semibold text-center">
        <div>
          <img className="h-12 ml-2 my-1" src={kateSpade} alt="Kate Spade" />
          <p>Kate Spade</p>
        </div>
        <div>
          <img className="pl-2 h-14" src={michaelKors} alt="Michael Kors" />
          <p>Michael Kors</p>
        </div>
        <div>
